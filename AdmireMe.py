...
msgText = MIMEText(
    '<center><h1>Thank you &#129351; @'+username+'&#129351; | Congratulations!</h1><img style="width:100%;" src="https://thepracticaldev.s3.amazonaws.com/i/6hqmcjaxbgbon8ydw93z.png"></img><center><p><t>Hello <b>@'+username+'</b>, <br><br>Thank you for your contribution in <b>'+org+'</b>.&#128519;<br><b>Note - Please find attached files.</b><br><br>~ Organization Maintainer <b>@'+org+'</b></p><center><img style="width:20em; height:auto;" src="https://media.giphy.com/media/du3J3cXyzhj75IOgvA/giphy.gif"></img><br></br><br></br><br></br></center></center><div style="text-align:center;width:100%;padding:20px;background:black;color:white;">Powered by Github Actions &emsp; &emsp; &emsp; | &emsp; &emsp; &emsp; Made for DEV.to Hackathon.<div></div>', 'html')
msg.attach(msgText)


# attach image
    
foreground = Image.open("C:\\Users\\PRATHAMESH\\Desktop\\Python try\\CCG.png")
